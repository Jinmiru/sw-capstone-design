//
// C:/UEProject/inventorykit/Intermediate/Build/Win64/x64/inventorykitServer/Development/Chaos/PerParticlePBDCollisionConstraint.ispc.generated.dummy_avx512skx.h
...
enum ImplicitObjectType {
    ...
    WeightedLatticeLevelSetType = 38,
    IsWeightedLattice = 32,
    IsInstanced = 64,
    IsScaled = 128 
};
#endif
...
extern "C" {
    ...
    extern void ApplyPerParticleCollisionFastFrictionNoGroupCheck(struct FVector4f * ParticlesPandInvM, const struct FVector3f * ParticlesX, const struct FVector3f * CollisionV, const struct FVector3f * CollisionX, const struct FVector3f * CollisionW, const struct FVector4f * CollisionR, const float PerGroupFriction, const float PerGroupThickness, const uint8_t * CollisionParticlesRange, const uint8_t * Geometry, const int32_t SizeofFImplicitObject, const int32_t OffsetofGeometryType, const int32_t OffsetOfMargin, const float Dt, const int32_t InnerCollisionCount, const int32_t OuterParticleBatchBegin, const int32_t OuterParticleBatchEnd);
    ...
    extern void ApplyPerParticleCollisionNoFrictionNoGroupCheck(struct FVector4f * ParticlesPandInvM, const struct FVector3f * ParticlesX, const struct FVector3f * CollisionV, const struct FVector3f * CollisionX, const struct FVector3f * CollisionW, const struct FVector4f * CollisionR, const float PerGroupThickness, const uint8_t * CollisionParticlesRange, const uint8_t * Geometry, const int32_t SizeofFImplicitObject, const int32_t OffsetofGeometryType, const int32_t OffsetOfMargin, const float Dt, const int32_t InnerCollisionCount, const int32_t OuterParticleBatchBegin, const int32_t OuterParticleBatchEnd);
