...
ALibraryBox::ALibraryBox()
{
	...
	CollisionBox->OnComponentBeginOverlap.AddDynamic(this, &ALibraryBox::OnBeginOverlap);
...
void ALibraryBox::OnBeginOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp,
