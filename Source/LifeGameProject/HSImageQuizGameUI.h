...
#include "HSImageQuizGameUI.generated.h"

/**
 * 
 */
UCLASS()
class LIFEGAMEPROJECT_API UHSImageQuizGameUI : public UUserWidget
{
	GENERATED_BODY()
...
public:
    ...
    void SetQuestion(UTexture2D* NewQuestionImage, FString NewQuestion, FString Answer);     // 생성된 문제를 위젯에 할당
...
private:
    ...
    TArray<FString> Questions;              // 문제 텍스트 배열
