...
#include "HSQuizGameUI.generated.h"

/**
 * 
 */
UCLASS()
class LIFEGAMEPROJECT_API UHSQuizGameUI : public UUserWidget
{
	GENERATED_BODY()
...
public:
    ...
    UPROPERTY(meta = (BindWidget))
    class UTextBlock* ChoicesText;             // 선택지 내용 텍스트
    ...
    void SetQuestion(FString NewQuestion, FString NewChoices, FString Answer);      // 생성된 문제를 위젯에 할당
