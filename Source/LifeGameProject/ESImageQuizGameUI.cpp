...
void UESImageQuizGameUI::SetRandomQuestion()
{
    // 이미지 파일 경로 및 정답 설정
    ImagePaths = {
        TEXT("/Game/MyAssets/Images/ImageQuizGame/ElementarySchool/Apple.Apple"),
        TEXT("/Game/MyAssets/Images/ImageQuizGame/ElementarySchool/Banana.Banana"),
        TEXT("/Game/MyAssets/Images/ImageQuizGame/ElementarySchool/Chair.Chair"),
        TEXT("/Game/MyAssets/Images/ImageQuizGame/ElementarySchool/Clock.Clock"),
        TEXT("/Game/MyAssets/Images/ImageQuizGame/ElementarySchool/Flower.Flower"),
        TEXT("/Game/MyAssets/Images/ImageQuizGame/ElementarySchool/Kimchi.Kimchi"),
        TEXT("/Game/MyAssets/Images/ImageQuizGame/ElementarySchool/Moon.Moon"),
        TEXT("/Game/MyAssets/Images/ImageQuizGame/ElementarySchool/Star.Star"),
        TEXT("/Game/MyAssets/Images/ImageQuizGame/ElementarySchool/Sun.Sun"),
        TEXT("/Game/MyAssets/Images/ImageQuizGame/ElementarySchool/Tree.Tree")
    };
