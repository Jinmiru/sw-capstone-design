...
// Sets default values
AESRunningGameBox::AESRunningGameBox()
{
	...
	CollisionBox->OnComponentBeginOverlap.AddDynamic(this, &AESRunningGameBox::OnBeginOverlap);

}

// Called when the game starts or when spawned
void AESRunningGameBox::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AESRunningGameBox::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void AESRunningGameBox::OnBeginOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp,
