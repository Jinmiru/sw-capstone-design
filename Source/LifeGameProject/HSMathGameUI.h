...
#include "HSMathGameUI.generated.h"

/**
 * 
 */
UCLASS()
class LIFEGAMEPROJECT_API UHSMathGameUI : public UUserWidget
{
	GENERATED_BODY()
...
public:
    ...
    void GenerateRandomExponentialQuestion();                   // 지수 문제 생성
    void GenerateRandomLogarithmicQuestion();                   // 로그 문제 생성
