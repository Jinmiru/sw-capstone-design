...
#include "MSServiceGameBoxBase.generated.h"

// 미리 선언
class UMSServiceGameUI;

UCLASS()
class LIFEGAMEPROJECT_API AMSServiceGameBoxBase : public AActor
{
    GENERATED_BODY()

public:
    AMSServiceGameBoxBase();
...
public:
    ...
    UMSServiceGameUI* GetServiceGameUI();
