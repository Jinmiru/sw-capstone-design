...
public:
	...
	UFUNCTION(Server, Reliable)
	void Server_EquipWeaponWithEffect(const FString& NiagaraPath, const FString& SkillEffectPath);

	UFUNCTION(NetMulticast, Reliable)
	void Multicast_EquipWeaponWithEffect(const FString& NiagaraPath, const FString& SkillEffectPath);
...
protected:
	...
	// 헤더 (.h)
	UFUNCTION(NetMulticast, Reliable)
	void Multicast_ChangeProfile(const FString& TextureAssetPath, const FString& name);
	void Multicast_ChangeProfile_Implementation(const FString& TextureAssetPath, const FString& name);
